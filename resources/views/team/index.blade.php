                ...
                @forelse ($level1 as $member)
                    <div class="bg-[#1E1F2B] p-3 rounded-lg flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <img src="{{ $member->profile_image_url ? asset('public/uploads/' . $member->profile_image_url) : 'https://placehold.co/48x48/1E1F2B/FFFFFF?text=' . strtoupper(substr($member->username, 0, 1)) }}" alt="member" class="w-12 h-12 rounded-full object-cover">
                            <div>
